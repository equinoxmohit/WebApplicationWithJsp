...
<div class="container">
    ...
    <form action="saveplaceholder.jsp" method="post">
        <label>Edit Placeholder Content:</label>    
        <textarea rows="10" class="form-control" required="required" name="content" placeholder="Write whatever you want to..."></textarea>
        <button class="btn btn-success">Save Placeholder Content</button>
